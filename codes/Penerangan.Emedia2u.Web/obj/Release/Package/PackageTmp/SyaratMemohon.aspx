<%@ Page Title="Home Page" MasterPageFile="~/Site.master" Language="C#" AutoEventWireup="true" CodeBehind="SyaratMemohon.aspx.cs"
    Inherits="Penerangan.Emedia2u.Web.SyaratMemohon" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:LinkButton ID="lnkBtnKembali" runat="server" OnClick="lnkBtnKembali_Click">Kembali</asp:LinkButton>
    </asp:Content>
