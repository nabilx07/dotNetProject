<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="MediaLuarNegara.aspx.cs" Inherits="Penerangan.Emedia2u.Web.Borang.MediaLuarNegara" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel ID="peribadiPanel" runat="server" 
        GroupingText="Maklumat Peribadi Pemohon" BackColor="#FFCCFF">
        <table class="style1">
            <tr>
                <td class="style10">
                    &nbsp;</td>
    ...
    Text="*" ErrorMessage="Pastikan tidak kosong"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="style16">
                    Tarikh Ketibaan:</td>
                <td>
                    <asp:TextBox ID="txtBoxTarikhKetibaan" runat="server" Width="310px">Contohnya : 28-02-2015</asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidator25" controltovalidate="txtBoxTarikhKetibaan" validationgroup="valGroup1" errormessage="Pastikan tidak kosong" ForeColor="Red" runat="server" />
                    <br />
                    <asp:Calendar ID="calendarKetibaan" runat="server" OnSelectionChanged="calendarKetibaan_SelectionChanged"></asp:Calendar>
                </td>
            </tr>
            <tr>
                <td class="style11">
                    &nbsp;</td>
                <td class="style16">
                    Pejabat Passport dikeluarkan:</td>
                <td>
                    <asp:TextBox ID="txtBoxPejabatPassportdikeluarkan" runat="server" Width="310px">Contohnya : 28-02-2015</asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidator26" controltovalidate="txtBoxPejabatPassportdikeluarkan" validationgroup="valGroup1" errormessage="Pastikan tidak kosong" ForeColor="Red" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="style11">
                    &nbsp;</td>
                <td class="style16">
                    Tarikh Tamat Tempoh:</td>
                <td>
                    <asp:TextBox ID="txtBoxTarikhTamatTempoh" runat="server" Width="310px">Contohnya : 28-02-2015</asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidator28" controltovalidate="txtBoxTarikhTamatTempoh" validationgroup="valGroup1" errormessage="Pastikan tidak kosong" ForeColor="Red" runat="server" />
                    <br />
                    <asp:Calendar ID="calendarTamattempoh" runat="server" OnSelectionChanged="calendarTamattempoh_SelectionChanged"></asp:Calendar>
                </td>
            </tr>
            <tr>
                <td class="style11">
    ...
    <asp:Panel ID="panelButirJabatan" runat="server" 
        GroupingText="Butir - Butir Jabatan/Organisasi Media" BackColor="#FFCCFF">
        <table class="style12">
            <tr>
                <td class="style14">
                    &nbsp;</td>
    ...
    <asp:Panel ID="panelPengesahan" runat="server" 
        GroupingText="Pengesahan oleh Ketua Jabatan/Wakil Kanan Organisasi Media" BackColor="#FFCCFF">
        <table class="style12">
            <tr>
                <td class="style18">
                    &nbsp;</td>
