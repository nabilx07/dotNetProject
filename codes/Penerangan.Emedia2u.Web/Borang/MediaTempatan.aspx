<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="MediaTempatan.aspx.cs" Inherits="Penerangan.Emedia2u.Web.Borang.MediaTempatan" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:Panel ID="peribadiPanel" runat="server" 
        GroupingText="Maklumat Peribadi Pemohon" BackColor="#99CCFF">
        <table class="style1">
            <tr>
                <td class="style10">
                    &nbsp;</td>
    ...
    <asp:Panel ID="panelButirJabatan" runat="server" 
        GroupingText="Butir - Butir Jabatan/Organisasi Media" BackColor="#99CCFF">
        <table class="style12">
            <tr>
                <td class="style14">
                    &nbsp;</td>
    ...
    <asp:Panel ID="panelPengesahan" runat="server" 
        GroupingText="Pengesahan oleh Ketua Jabatan/Wakil Kanan Organisasi Media" BackColor="#99CCFF">
        <table class="style12">
            <tr>
                <td class="style18">
                    &nbsp;</td>
