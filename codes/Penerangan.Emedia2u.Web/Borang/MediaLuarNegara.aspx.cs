...
{
    public partial class MediaLuarNegara : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (recaptcha.IsValid)
            {
                ...
                DateTime applicant_arrival = Convert.ToDateTime(txtBoxTarikhKetibaan.Text);
                string applicant_pass_placeissue = txtBoxPejabatPassportdikeluarkan.Text;
                DateTime applicant_pass_expiry = Convert.ToDateTime(txtBoxTarikhTamatTempoh.Text);
                ...
                int officer_id = 0;
                DateTime applicant_dateissue = Convert.ToDateTime(DateTime.Now);
                DateTime applicant_dateexpiry = Convert.ToDateTime(DateTime.Now);
        ...
        protected void calendarKetibaan_SelectionChanged(object sender, EventArgs e)
        {
            txtBoxTarikhKetibaan.Text = calendarKetibaan.SelectedDate.ToString();
        }

        protected void calendarTamattempoh_SelectionChanged(object sender, EventArgs e)
        {
            txtBoxTarikhTamatTempoh.Text = calendarKetibaan.SelectedDate.ToString();
        }
